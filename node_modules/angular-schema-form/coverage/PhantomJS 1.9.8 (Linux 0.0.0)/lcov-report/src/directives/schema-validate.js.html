...
<div class="header medium">
    ...
    <h2>
        ...
        Branches: <span class="metric">35.29% <small>(12 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!result.valid) {
...
<span class="cstat-no" title="statement not covered" >          console.log(ngModel)</span>
<span class="cstat-no" title="statement not covered" >          return viewValue;</span>
        };
&nbsp;
...
&nbsp;
        ...
        scope.validateField =  <span class="fstat-no" title="function not covered" >function() {</span>
&nbsp;
          // Special case: arrays
          ...
          // 1.2 support.
<span class="cstat-no" title="statement not covered" >          if (schema &amp;&amp; schema.type.indexOf('array') !== -1) {</span>
<span class="cstat-no" title="statement not covered" >            validate(ngModel.$modelValue);</span>
          }
&nbsp;
          // We set the viewValue to trigger parsers,
          // since modelValue might be empty and validating just that
          // might change an existing error to a "required" error message.
<span class="cstat-no" title="statement not covered" >          if (ngModel.$setDirty) {</span>
&nbsp;
            // Angular 1.3+
...
<span class="cstat-no" title="statement not covered" >              console.log('setting invalid')</span>
