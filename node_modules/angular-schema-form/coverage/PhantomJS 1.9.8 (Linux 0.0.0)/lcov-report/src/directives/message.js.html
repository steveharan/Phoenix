...
<html lang="en">
<head>
    <title>Code coverage report for src/directives/message.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/directives/message.js</span></h1>
    <h2>
        Statements: <span class="metric">96.55% <small>(28 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">78.26% <small>(18 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(8 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.43% <small>(27 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/directives/</a> &#187; message.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">angular.module('schemaForm').directive('sfMessage',
['$injector', 'sfErrorMessage', function($injector, sfErrorMessage) {
&nbsp;
  //Inject sanitizer if it exists
  var $sanitize = $injector.has('$sanitize') ?
<span class="branch-0 cbranch-no" title="branch not covered" >                  $injector.get('$sanitize') </span>: function(html) { return html; };
&nbsp;
  return {
    scope: false,
    restrict: 'EA',
...
&nbsp;
      var message = '';
      <span class="missing-if-branch" title="else path not taken" >E</span>if (attrs.sfMessage) {
        scope.$watch(attrs.sfMessage, function(msg) {
          if (msg) {
            message = $sanitize(msg);
            <span class="missing-if-branch" title="else path not taken" >E</span>if (scope.ngModel) {
...
&nbsp;
          if (error) {
            element.html(sfErrorMessage.interpolate(
              ...
              scope.form,
              scope.options &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >scope.options.validationMessage</span>
            ));
          } else {
            element.html(message);
          }
