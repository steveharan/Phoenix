...
<html lang="en">
<head>
    <title>Code coverage report for src/services/errors.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/services/errors.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/services/</a> &#187; errors.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">angular.module('schemaForm').provider('sfErrorMessage', function() {
&nbsp;
...
&nbsp;
  this.setDefaultMessages = <span class="fstat-no" title="function not covered" >function(messages) {</span>
<span class="cstat-no" title="statement not covered" >    defaultMessages = messages;</span>
  };
&nbsp;
  this.getDefaultMessages = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    return defaultMessages;</span>
  };
&nbsp;
  this.setDefaultMessage = <span class="fstat-no" title="function not covered" >function(error, msg) {</span>
<span class="cstat-no" title="statement not covered" >    defaultMessages[error] = msg;</span>
  };
&nbsp;
...
&nbsp;
     ...
     */
    service.interpolate = <span class="fstat-no" title="function not covered" >function(error, value, viewValue, form, global) {</span>
<span class="cstat-no" title="statement not covered" >      global = global || {};</span>
<span class="cstat-no" title="statement not covered" >      var validationMessage = form.validationMessage || {};</span>
&nbsp;
      // Drop tv4 prefix so only the code is left.
<span class="cstat-no" title="statement not covered" >      if (error.indexOf('tv4-') === 0) {</span>
<span class="cstat-no" title="statement not covered" >        error = error.substring(4);</span>
      }
&nbsp;
      // First find apropriate message or function
<span class="cstat-no" title="statement not covered" >      var message = validationMessage['default'] || global['default'] || '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      [validationMessage, global, defaultMessages].some(<span class="fstat-no" title="function not covered" >function(val) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (angular.isString(val) || angular.isFunction(val)) {</span>
<span class="cstat-no" title="statement not covered" >          message = val;</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (val &amp;&amp; val[error]) {</span>
<span class="cstat-no" title="statement not covered" >          message = val[error];</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
      });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (angular.isFunction(message)) {</span>
<span class="cstat-no" title="statement not covered" >        return message(context);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        return $interpolate(message)(context);</span>
      }
    };
&nbsp;
    return service;
